...
export const ROUTES = {
  ...
  ACCCOUNT_ACTIVATION: 'account-activation',
}
...
export const VALIDATION_TEXTS = {
  ...
  PASSWORD_MIN_8: 'passwordMin8Characters',
  PASSWORD_UPPER_AND_LOWERCASE: 'passwordUpperAndLowercase',
  PASSWORD_1_DIGIT: 'passwordOneDigit',
  PASSWORD_CONFIRM_MATCH: 'passwordConfirmMatch',
  AGREEMENTS_REQUIRED: 'agreementsRequired',
}
